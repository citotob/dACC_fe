...
function TableIssue(props) {
  ...
  const fetchData = async () => {
    ...
    fetch(`${process.env.REACT_APP_BE_URL}/survey/getissuebysurveyor/`, {
      method: "POST",
      body: JSON.stringify({
            ...
            <CardBody style={{ padding: "0.5rem" }}>
              ...
              <div className={"d-flex w-100 justify-content-between"}>
                ...
                <DateRangePicker
                  ...
                  startDate="1/1/2014"
                  endDate="3/1/2014">
                  <input bssize="sm" name="dateRange" className={`${styles.input} form-control-sm`} />
                  {/* onChange={(e) => setDate(`${e.target.value} 00:00:00`)} */}
                </DateRangePicker>
              </div>
            </CardBody>
