      ...
      <div id='sidebar-menu'>
        ...
        {role === "cs" && (
          <ul className='metismenu list-unstyled' id='side-menu'>
            ...
            <li>
              <Link to='/cs/dashboard' className='waves-effect'>
                <div className='sidebar-menu-wrapper'>
                  <div className='sidebar-icon-wrapper'>
                    <svg
                      width='14'
            ...
            <li>
              ...
              <ul className="sub-menu" aria-expanded="false">
                <li>
                  <Link to="/cs/bank">{props.t("BANK")}</Link>
                </li>
                <li>
                  <Link to="/cs/accbank">{props.t("REKENING")}</Link>
                </li>
                <li>
                  <Link to="/cs/whitelabel">{props.t("WHITELABEL")}</Link>
                </li>
              </ul>
            </li>
            ...
            <li>
              ...
              <ul className="sub-menu" aria-expanded="false">
                <li>
                  <Link to="/cs/deposit">{props.t("DEPOSIT")}</Link>
                </li>
                <li>
                  <Link to="/cs/withdrawal">{props.t("WITHDRAWAL")}</Link>
                </li>
                <li>
                  <Link to="/cs/bonus">{props.t("BONUS")}</Link>
                </li>
              </ul>
            </li>
            ...
            <li>
              ...
              <ul className="sub-menu" aria-expanded="false">
                <li>
                  <Link to="/cs/report_transaksi">{props.t("TRANSAKSI")}</Link>
                </li>
              </ul>
            </li>
          </ul>
