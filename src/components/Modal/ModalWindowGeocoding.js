...
import FormGeocoding from "../Forms/FormGeocoding";
import GeocodeIcon from "../../asset/icons/geocode.svg";
...
const ModalGeocoding = ({ mapRef, onSubmit }) => {
	...
	return (
		<>
			<Icon onClick={toggle} source={GeocodeIcon} text={"Geocoding"} />
...
ModalGeocoding.defaultProps = {
	mapRef: () => console.log("MAP REF"),
	onSubmit: () => console.log("ON SUBMIT"),
};

export default ModalGeocoding;
