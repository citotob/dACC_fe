  ...
  return (
    <View style={styles.sectionContainer} wrap={false}>
      <View style={styles.movieDetails}>
        ...
        <View style={styles.subtitle}>
          <View style={styles.vote}>
            <Text style={styles.vote_text}>Foto Lokasi: </Text>
          </View>
          {/* <View style={styles.movieDetails}>
          <Text style={styles.movieTitle}>foto</Text>
          <Image source="https://lh3.googleusercontent.com/proxy/rXX6Hyc89hN43B1MsqOPWqrGs25nBbjxymAkpTw7omTeueznNuRjaNSqWGF2lQA1szKsVawtdmTergmgt_elp1v8YUOL168KinoAQqyQISxB" />
        </View> */}
          <View style={styles.vote}>
            {Object.entries(data).map(([key, value]) => {
              let source = `${process.env.REACT_APP_BE_URL}${value.url}`;
              let sourceCORS = {
                uri: `${process.env.REACT_APP_BE_URL}${value.url}`,
                method: 'GET',
                headers: {
              ...
              return (
                <>
                  <View style={styles.movieDetailsimg}>
