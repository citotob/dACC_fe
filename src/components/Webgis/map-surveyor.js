...
class MapsSurveyor extends Component {
  constructor(props) {
    super();
    this.state = {
      isLoading: true,
  ...
  componentDidMount() {
    this.setState({ surveyor: this.props.surveyor });
  };
            ...
            <div style={containerCSS}>
              ...
              <Map
                ...
                onStyleLoad={async (map, load) => {
                  ...
                  const url = `${process.env.REACT_APP_BE_URL}/survey/getpenugasan/surveyor/provinsi`;
                  ...
                  await fetch(
                    ...
                    .then(async (result) => {
                      ...
                      _.map(INDONESIA.features, function (p) {
                        _.map(result.values, function (key, value) {
