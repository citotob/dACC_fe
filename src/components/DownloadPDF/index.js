  ...
  return (
    <View style={styles.sectionContainer} wrap={true}>
      <View style={styles.movieDetails}>
        ...
        {/* <View style={styles.vote}>
          <Text style={styles.movieTitleimg}>{title('aksesJalan')}</Text>
        </View>
        <View style={styles.vote}>
          <Image
            src={`${process.env.REACT_APP_BE_URL}${data.aksesJalan.url}`}
            style={styles.image}
            crossorigin="anonymous"
          />
        </View>
        ...
        <View style={styles.vote}>
          <Text style={styles.movieTitleimg}>{title('plang')}</Text>
        </View>
        <View style={styles.vote}>
          <Image
            src={`${process.env.REACT_APP_BE_URL}${data.plang.url}`}
            style={styles.image}
            crossorigin="anonymous"
          />
        </View>
        ...
        <View style={styles.vote}>
          <Text style={styles.movieTitleimg}>{title('markingPerangkat')}</Text>
        </View>
        <View style={styles.vote}>
          <Image
            src={`${process.env.REACT_APP_BE_URL}${data.markingPerangkat.url}`}
            style={styles.image}
            crossorigin="anonymous"
          />
        </View>
        ...
        <View style={styles.vote}>
          <Text style={styles.movieTitleimg}>{title('kwhMeter')}</Text>
        </View>
        <View style={styles.vote}>
          <Image
            src={`${process.env.REACT_APP_BE_URL}${data.kwhMeter.url}`}
            style={styles.image}
            crossorigin="anonymous"
          />
        </View>
        ...
        <View style={styles.vote}>
          <Text style={styles.movieTitleimg}>{title('gambarDenah')}</Text>
        </View>
        <View style={styles.vote}>
          <Image
            src={`${process.env.REACT_APP_BE_URL}${data.gambarDenah.url}`}
            style={styles.image}
            crossorigin="anonymous"
          />
        </View>
        ...
        <View style={styles.vote}>
          <Text style={styles.movieTitleimg}>{title('lanskapBangunan')}</Text>
        </View>
        <View style={styles.vote}>
          <Image
            src={`${process.env.REACT_APP_BE_URL}${data.lanskapBangunan.url}`}
            style={styles.image}
            crossorigin="anonymous"
          />
        </View> */}
...
const DownloadPDF = ({ dataDetail, jenisSurvey, issue }) => {
