...
// Import Components
import Table from "../../components/Role/TableBootstrap/TableBootstrap";
...
function Role() {
  ...
  // initial data for modal tambah Role
  const getInitData = () => {
    API.getRole()
      .then((res) => {
    ...
    return (
      ...
      >
        <div className={`modal-body ${style.modalBody}`}>
          ...
          <h5 className={style.title}>Tambahkan Role</h5>
          {/* ============================== form start  */}
          ...
          <AvForm className='form-horizontal' onValidSubmit={() => postRegis()}>
            ...
            />
            <label className='col-form-label'>Pilih Tipe Role</label>
            <div>
              <select
                name='role'
  ...
  return (
    <div>
      <div className={`${alertAddDataStatus}`}>
        <Alert color='success'>Role berhasil di Ditambahkan!</Alert>
      </div>
      <div className='page-content px-4'>
        ...
        <div className='d-flex flex-row justify-content-between'>
          ...
          <div>
            <Breadcrumbs title='Data Role' breadcrumbItem='Verifikasi' />
          </div>
        </div>
        {/* ======================== CONTENT ======================= */}
        <div className='py-4'>
