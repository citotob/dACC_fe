...
import { Row, Button, Container, Card, CardHeader } from "reactstrap";
...
const LokasiSurvey = () => {
  const [menu, setMenu] = useState("Akses Internet");
  const [modalTambahLokasi, setModalTambahLokasi] = useState(false);
