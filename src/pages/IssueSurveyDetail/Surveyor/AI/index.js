            ...
            <div>
              ...
              {tab === "AI"
                ? <Button className={`ml-5 mr-15 ${styles.btnDownloadPDF}`}>
                  {isReady ? <DownloadPDFSurveyor dataDetail={dataIssue} jenisSurvey={jenis_survey} issue={true} /> : ""}
                </Button>
                : <Button className={`ml-5 mr-15 ${styles.btnDownloadPDF}`}>
                  {isReady ? <DownloadPDFBTSSurveyor dataDetail={dataIssue} jenisSurvey={jenis_survey} issue={true} /> : ""}
                </Button>
              }
            </div>
          </div>
