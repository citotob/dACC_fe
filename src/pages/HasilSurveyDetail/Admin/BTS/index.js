          ...
          <div className={`${styles.wrapper_title} d-flex justify-content-between`}>
            ...
            <div>
              <Button className={`ml-5 mr-15 ${styles.btnDownloadPDF}`}>
                {isReady ? <DownloadPDFBTS dataDetail={dataDetail} jenisSurvey={jenis_survey} issue={false} /> : ""}
              </Button>
            </div>
          </div>
        </Container>
...
const HasilSurveyDetailAdminBTS = (props) => {
  // Change status Penugasan to reviewed upon open
...
export default HasilSurveyDetailAdminBTS;
