									...
									<Row className="mb-2">
										...
										<Col sm="8">
											<div className="text-sm-right">
												...
												>
													<i className="mdi mdi-plus mr-1"></i> New Customers
												</Button>
											</div>
										</Col>
									</Row>
										...
										<Table className="table-centered table-nowrap">
											...
											<tbody>
												<tr>
													...
													<td>
														<UncontrolledDropdown>
															...
															<DropdownMenu right>
																<DropdownItem href="#">
																	<i className="mdi mdi-pencil font-size-16 text-success mr-2"></i>
																	Edit
																</DropdownItem>
																<DropdownItem href="#">
												...
												<tr>
													...
													<td>3755 Harron Drive Salisbury, MD 21875</td>
													<td>
														<Badge color="success" className="font-size-12">
															<i className="mdi mdi-star mr-1"></i> 4.0
														</Badge>
													</td>
													<td>$5,632</td>
													<td>06 Oct, 2019</td>
