					...
					<CardBody>
						...
						<Row>
							...
							<Col lg="4" sm="6" className="align-self-center">
								<div>
									<p className="mb-2">
										<i className="mdi mdi-circle align-middle font-size-10 mr-2 text-primary"></i>{" "}
										Ethereum
									</p>
									<h5>
										4.5701 ETH ={" "}
								...
								<div className="mt-4 pt-2">
									<p className="mb-2">
										<i className="mdi mdi-circle align-middle font-size-10 mr-2 text-warning"></i>{" "}
										Bitcoin
									</p>
									<h5>
										0.4412 BTC ={" "}
								...
								<div className="mt-4 pt-2">
									<p className="mb-2">
										<i className="mdi mdi-circle align-middle font-size-10 mr-2 text-info"></i>{" "}
										Litecoin
									</p>
									<h5>
										35.3811 LTC ={" "}
